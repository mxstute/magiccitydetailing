...
export default async function handler(req, res) {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `${req.headers.origin || 'https://magiccitydetailingmiami.com'}?booking=success`,
      cancel_url: `${req.headers.origin || 'https://magiccitydetailingmiami.com'}?booking=cancelled`,
    });
